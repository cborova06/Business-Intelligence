		...
		<template #body>
			<div class="min-w-[36rem] rounded-lg bg-white px-4 pb-6 pt-5 text-base sm:px-6">
				<div class="flex items-center justify-between pb-4">
					<h3 class="text-2xl font-semibold leading-6 text-gray-900">{{ __("Summarize") }}</h3>
				...
				<div class="flex flex-col gap-4">
					<div class="flex gap-4">
						<div class="flex-1 flex-shrink-0">
							<p class="mb-1.5 text-p-sm text-gray-600">{{ __("Group By") }}</p>
						...
						<div class="flex-1 flex-shrink-0">
							<p class="mb-1.5 text-p-sm text-gray-600">{{ __("Aggregate") }}</p>
							<div class="flex flex-col gap-2">
								<MeasurePicker
					...
					<div class="mt-2 flex justify-end">
						<div class="flex gap-2">
							<Button :label="__('Clear')" variant="outline" @click="resetSelections" />
							<Button
								:label="__('Done')"
								variant="solid"
