...
<template>
	<div>
		<div class="flex gap-2">
			<FormControl type="number" :placeholder="__('Min')" :label="__('Min')" v-model="filter.value[0]" />
			<FormControl type="number" :placeholder="__('Max')" :label="__('Max')" v-model="filter.value[1]" />
		</div>
