...
export const AGGREGATIONS = [
	{ label: __('Unique'), value: 'group by', description: __('Group by') },
	{ label: __('Count of Records'), value: 'count', description: __('Count') },
	{ label: __('Sum of'), value: 'sum', description: __('Sum') },
	{ label: __('Average of'), value: 'avg', description: __('Average') },
	{
		label: __('Cumulative Count of Records'),
		value: 'cumulative count',
		description: __('Cumulative Count'),
	},
	{ label: __('Cumulative Sum of'), value: 'cumulative sum', description: __('Cumulative Sum') },
	{ label: __('Unique values of'), value: 'distinct', description: __('Distinct') },
	{ label: __('Unique count of'), value: 'distinct_count', description: __('Distinct Count') },
	{ label: __('Minimum of'), value: 'min', description: __('Minimum') },
	{ label: __('Maximum of'), value: 'max', description: __('Maximum') },
]

export const GRANULARITIES = [
	{ label: __('Minute'), value: 'Minute', description: __('January 12, 2020 1:14 PM') },
	{ label: __('Hour'), value: 'Hour', description: __('January 12, 2020 1:00 PM') },
	{ label: __('Hour of Day'), value: 'Hour of Day', description: __('1:00 PM') },
	{ label: __('Day'), value: 'Day', description: __('12th January, 2020') },
	{ label: __('Day Short'), value: 'Day Short', description: __('12th Jan, 20') },
	{ label: __('Week'), value: 'Week', description: __('12th January, 2020') },
	{ label: __('Month'), value: 'Month', description: __('January, 2020') },
	{ label: __('Mon'), value: 'Mon', description: __('Jan 20') },
	{ label: __('Quarter'), value: 'Quarter', description: __('Q1, 2020') },
	{ label: __('Year'), value: 'Year', description: '2020' },
	{ label: __('Day of Week'), value: 'Day of Week', description: __('Monday') },
	{ label: __('Month of Year'), value: 'Month of Year', description: __('January') },
	{ label: __('Quarter of Year'), value: 'Quarter of Year', description: 'Q1' },
]
...
export function getOperatorOptions(columnType) {
	...
	if (FIELDTYPES.TEXT.includes(columnType)) {
		options = options.concat([
			...
			{ label: __('not contains'), value: 'not_contains' },
			{ label: __('starts with'), value: 'starts_with' },
			{ label: __('ends with'), value: 'ends_with' },
			{ label: __('one of'), value: 'in' },
			{ label: __('not one of'), value: 'not_in' },
		])
	}
	if (FIELDTYPES.NUMBER.includes(columnType)) {
		options = options.concat([
			...
			{ label: __('smaller than'), value: '<' },
			{ label: __('greater than equal to'), value: '>=' },
			{ label: __('smaller than equal to'), value: '<=' },
