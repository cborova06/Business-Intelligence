...
export const FUNCTIONS = {
	...
	timespan: {
		...
		description: __('Checks if column value is within the timespan.'),
		example: 'timespan(`invoice.creation`, "Last 7 Days")',
		returnType: 'boolean',
	},
	now: {
		syntax: 'now()',
		description: __('Gets current date and time.'),
		example: '`invoice.posting_date` = now()',
		returnType: 'datetime',
	},
	today: {
		syntax: 'today()',
		description: __('Gets current date.'),
		example: '`invoice.posting_date` = today()',
		returnType: 'date',
	},
	format_date: {
		syntax: 'format_date(date, "format")',
		description: __('Formats date to the given format.'),
		example: 'format_date(`invoice.posting_date`, "DD-MM-YYYY")',
		returnType: 'string',
	},
	start_of: {
		syntax: 'start_of(unit, date)',
		description: __('Finds start of the given unit (e.g., Month, Year).'),
		example: 'start_of("Month", today())',
		returnType: 'date',
	},
	time_elapsed: {
		syntax: 'time_elapsed(unit, date1, date2)',
		description: __('Calculates time between two dates.'),
