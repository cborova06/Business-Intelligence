	...
	>
		<template #body-content>
			<div class="prose prose-sm mb-4">
				<p>
					{{ __("Switch to the newest version of Insights, built from the ground up for a better experience.") }}
				</p>
				<p>
					{{ __("You can always switch back to this version by clicking the \"Switch to Insights v2\" button in the new version.") }}
				</p>
			</div>
			<FormControl
				type="checkbox"
				:label="__('Set Insights v3 as default')"
