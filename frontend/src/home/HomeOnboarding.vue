...
const steps = reactive([
	{
		...
		name: 'connect_data',
		description: __("Insights needs access to your data to start analyzing it. Don't worry, we do not store your data."),
		primary_button: {
	...
	},
	{
		...
		name: 'build_query',
		description: __("Let's introduce you to the query builder, where you'll be spending most of your time building queries."),
		primary_button: {
	...
	},
	{
		...
		description: __('Organize your visualizations meaningfully by creating a dashboard for you and your team.'),
		primary_button: {
